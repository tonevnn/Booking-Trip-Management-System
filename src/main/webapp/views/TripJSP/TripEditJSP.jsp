    ...
    <div class="row">
        ...
        <div class="col-10 px-0">
            <div class="pt-5 ps-5 pe-5">
                <p class="h2 fw-normal mb-3">Edit Trip <c:if test="${requestScope.message ne null}"><span
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-5">
                                <input type="time" class="form-control" id="txtDepartureTime"
                                       ...
                                       value="${requestScope.trip.departureTime}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-2">
                            ...
                            <div class="col-5">
                                <input type="text" class="form-control" id="txtDriver" name="txtDriver"
                                       placeholder="Enter driver" value="${requestScope.trip.driver}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-2">
                            ...
                            <div class="col-5">
                                <input type="text" class="form-control" id="txtCarType" name="txtCarType"
                                       placeholder="Enter car type" value="${requestScope.trip.carType}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-2">
                            ...
                            <div class="col-5">
                                <input type="text" class="form-control" id="txtMaximumTickerNumber"
                                       ...
                                       value="${requestScope.trip.maximumOnlineTicketNumber}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-2">
                            ...
                            <div class="col-5">
                                <input type="text" class="form-control" id="txtDepartureDate"
                                       ...
                                       value="<fmt:formatDate type="date" value="${requestScope.trip.departureDate}" pattern="dd/MM/yyyy"/>"
                                       required>
                            </div>
                        </div>
                        <div class="row mb-3">
